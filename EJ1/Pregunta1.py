#El problema se basa en tener un arreglo ordenado de enteros y tres enteros a, b, c. 
#Se debe aplicar la funcion 𝑓(𝑥)=𝑎𝑥2+𝑏𝑥+𝑐 a cada elemento del arreglo de enteros y volver a ordenar el arreglo en orden.
#Para esto haremos una funcion ordenarArregloCuadratico la cual recibe el arreglo y los tres enteros a,b,c.
#Aplicaremos la funcion cadratica a cada elemento y con varios condicionadores proceder a 
#ordenar los enteros en el arreglo para retornar el arreglo ordenado.
#Para probar que el ejercicio funciona aplicamos una funcion unittest para confirmar que las respuestas sean correctas e
#hicimos 5 ejemplos con 5 arreglos y tres eneteros diferentes.
